...
function levels:make_draw_open_door(x,y)
  local doorx,doory=self.current.doorx,self.current.doory
  local x,y=doorx*8+6,doory*8+2
  local frame=0
  ...
  return function()
    ...
    local t=time()
    local playerdistance=sqrt((player.x-x)^2+(player.y-y)^2)

    for i=1,8 do
      local tmod=t/8+i/8
      local length=playerdistance-16+8*cos(t/4)
      line(x,y,x-length*cos(tmod),y+length*sin(tmod),10)
    end
  end
end
...
menuitem(4,"spawn bee", function()
	bees:add(levels.current.x1+12,levels.current.y1+12)
...

...

...

__sfx__
