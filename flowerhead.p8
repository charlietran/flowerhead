...
function bombs:add()
	add(self.list,entity_class:new({
    x=player.x,y=player.y-1,
		w=3,h=3,
    wr=1,hr=1,
    vx=(.5+rnd(.25))*player.facing+player.vx*0.5,
    vy=-2.5,
		spr_x=16,spr_y=8,
		anim={timer=0,frames=8,speed=1/3},
		collide_callback=bombs.collide_callback,
		explode=bombs.explode
  }))
end

function bombs:collide_callback(collision)
...
function bombs:explode()
	explosions.add(self.x,self.y,6)
	for i=self.x+9,self.x-9,-1 do
...

